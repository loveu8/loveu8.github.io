    ...
    },
    {
      ...
      boxes: [
        ...
        { type: "info",
          ...
          body: { zh: "高載客率是正向訊號，但不等於航線會獲利：BITRE 沒有經香港、新加坡等轉機選項的客流，也沒有票價。上方情境顯示，若華航加到每日、星宇每週開 4–5 班，單向座位會超過 2019 年；若維持 80% 載客率，每向需要約 14–15 萬名旅客，是 2025 年的兩倍以上。這不是預測，而是提醒真正問題在於新增座位能否吸收轉機客與新增需求。",
            en: "A high load factor is positive, but it doesn't prove profitability: BITRE has neither traffic through hubs such as Hong Kong and Singapore nor fare data. The scenario above shows that if China Airlines goes daily and STARLUX flies 4–5 times a week, one-way seats would exceed 2019 levels; sustaining an 80% load factor would require about 140,000–150,000 passengers each way, more than double 2025. This isn't a forecast — it shows that the real question is whether added seats can absorb connecting traffic and new demand." } }
      ]
    },
    {
      id: "s8",
