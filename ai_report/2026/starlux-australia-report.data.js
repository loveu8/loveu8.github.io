...
var STARLUX_REPORT_DATA = (function () {
  ...
  var UI = {
    ...
    reportMeta: { zh: "更新日期：2026 年 9 月 22 日 · 個人研究整理，非投資建議", en: "Last updated: September 22, 2026 · Personal research notes, not investment advice" },
  ...
  var STORIES = [
    ...
    },
    {
      ...
      boxes: [
        { type: "caution",
          ...
          body: { zh: "澳洲對台灣的出口大宗是煤炭、天然氣這類大宗商品，不太可能走空運，這 279 億裡也拆不出多少是空運。改查澳洲官方的空運貿易資料：台灣→澳洲方向，2025 年空運貨值約 18 億澳幣，2026 上半年已達 27 億——半年就超過去年全年——依目前整理，2025 年約八成集中在「機械與運輸設備」（含電子零組件），跟台灣電子代工的強項一致。但貨物金額不等於重量，現有資料無法判定這批貨有多少由台澳直飛、經第三地轉運，或會成為星宇雪梨線的貨源，細節見後面「貨到底運什麼」這章。",
    ...
    },
    {
      ...
      chart2: {
        ...
        title: { zh: "2025 年新南威爾斯州（NSW）→台灣空運貨值，按商品分類（百萬澳幣）", en: "New South Wales (NSW)→Taiwan air-freight value in 2025, by commodity category (A$m)" },
    ...
    },
    {
      ...
      boxes: [
        { type: "caution",
          ...
          body: { zh: "國泰的香港樞紐規模大約是星宇台北樞紐的 2.4 倍航點數、2.3 倍國家數；雪梨更是國泰在澳洲最熱門的航點（2026 年第一季從香港出發 351 班，約每週 27 班，領先墨爾本、伯斯、布里斯本，屬季度平均、非九月現行班表），頻率是星宇規劃的好幾倍。而且香港—台北目前是國泰全公司運能最大的單一航線（雙向約 290 萬座位、年增 7%），顯示國泰在港台之間的供給規模很大；台灣出發旅客實際經香港轉機的占比，目前仍待資料確認。這不代表星宇打不贏——精品定位、機型、服務都是差異化空間——但基期差距這麼大，樂觀敘事要收斂，不能只講「星宇多了一個轉運選項」，不提對手規模。",
